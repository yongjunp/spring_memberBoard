		...
		<div class="contents">
			...
			<div class="formWrap">
				<form action="${pageContext.request.contextPath}/updateInfo"
					...
					<div class="formRow">
						<input type="text" id="inputId" placeholder="${sessionScope.loginMemberId}" readonly>
					</div>
					<div class="formRow"> 
						<input type="text" name="mpw" placeholder="비밀번호입력" value="${mem.mpw }">
					</div>
					<div class="formRow">
						<input type="text" name="mname" placeholder="이름입력" value="${mem.mname }">
					</div>
					<div class="formRow">
						<input type="date" name="mbirth" value="${mem.mbirth }">
					</div>
					<div class="formRow">
						<input type="text" name="memailId" placeholder="이메일아이디" value = "${memailId }"> @
						<input type="text" id="edomain" name="memailDomain"
							placeholder="이메일도메인" value = "${memailDomain }">
					</div>
